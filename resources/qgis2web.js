...
var map = new ol.Map({
    ...
    layers: layersList,
    view: new ol.View({
        extent: [-11613957.625367, 5865952.969486, -11389682.584243, 6122290.025509], maxZoom: 28, minZoom: 1
    })
});

//initial view - epsg:3857 coordinates if not "Match project CRS"
map.getView().fit([-11613957.625367, 5865952.969486, -11389682.584243, 6122290.025509], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Theodore Roosevelt National Park</h2>';
        return titleElement;
    })(),
